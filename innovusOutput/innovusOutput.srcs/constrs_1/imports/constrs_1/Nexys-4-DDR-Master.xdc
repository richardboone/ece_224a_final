...
# Clock signal
set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports CLK10MHZ]
create_clock -period .1000 -name sys_clk_pin -waveform {0.000 .5000} -add [get_ports CLK10MHZ]
